 ...
 *
 * The parent app's iOS listing is live; the "us" storefront is used explicitly
 * so the link doesn't follow the visitor's locale (e.g. Apple's "vn" storefront).
 * There is no child iOS listing yet, so CHILD_APP_STORE_URL stays a bare storefront link.
 *
...
export const APP_STORE_URL =
  ...
  "https://apps.apple.com/us/app/guardiane/id6749015850";

/** The child app's iOS listing — no live listing yet, so a bare storefront link. */
export const CHILD_APP_STORE_URL =
  process.env.NEXT_PUBLIC_CHILD_APP_STORE_URL ?? "https://apps.apple.com/";
