...
const whatYouGetFaqs = [
  {
    ...
    content: (
      <p>
        See how they’re doing at a glance—mood levels, history, and charts that
        help you spot patterns before they become problems.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <p>
        Modules, lessons, assignments, and streaks in one hub—so growth shows up
        as progress you can see and celebrate.
      </p>
    ),
  },
  {
                ...
                <div className="clarity-card relative z-10 overflow-hidden p-0 mockup-shadow">
                  ...
                  <div className="space-y-3 p-5 text-sm">
                    ...
                    <div className="max-w-[88%] rounded-2xl rounded-bl-sm border border-[var(--border)] bg-white px-4 py-3 text-left text-[var(--muted)] mb-10">
                      Yes—threat-aware texting surfaced two phrases for review.
                      Mood board is steady; screen time dipped after school.
                      Open{" "}
                      <Link
                        href="#features"
                  ...
                  <div className="flex items-center gap-3 border-t border-[var(--border)] bg-white px-4 py-3">
                    ...
                    <p className="text-xs text-[var(--muted)]">
                      Drawer: switch kids, mood boards, and learning
          ...
          <div className="clarity-wrap px-4 py-10 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="clarity-prose mx-auto mt-5 max-w-4xl text-sm">
                ...
                needs, surfaced in one dashboard built for how families actually
                live.
              </p>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
              <div data-reveal>
                ...
                <p className="clarity-prose text-sm">
                  Mood, screen time, learning, and messaging—one dashboard that
                  turns scattered signals into a clear, single story.
                </p>
